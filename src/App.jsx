...
function App() {
  ...
  return (
    <div className="flex justify-center bg-gray-200">
      ...
      <div className='mx-4 self-center text-center bg-auto '>
      <h1 className='text-5xl py-1 font-bold text-blue-700'>Welcome to Almusawee Layout</h1>
      <h2 className='text-3xl py-2 font-semibold text-blue-300'>A premium websites' UI/UX designs center</h2>
