...
function App() {
  ...
  return (
    <div className="flex justify-center bg-gray-200  ">
      ...
      <button className='my-4 px-4 py-2 border-2 border-black rounded-lg text-white bg-blue-900 hover:animate-pulse animate-bounce hover:text-slate-900 hover:bg-sky-700 '>Learn more</button>
      </div>
    </div>
  )
}
